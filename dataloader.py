...
def get_dataloaders(config, tokenizer, skip_train=False,
  ...
  print(f"config.loader.global_batch_size: {config.loader.global_batch_size}")
  print(f"config.loader.batch_size: {config.loader.batch_size}")
  print(f"config.trainer.num_nodes: {config.trainer.num_nodes}")
  print(f"config.trainer.accumulate_grad_batches: {config.trainer.accumulate_grad_batches}")
